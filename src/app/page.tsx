          ...
          <div className="highlight w-11/12 2xl:ml-40 2xl:w-1/2">
            ...
            <div className="mt-10 ">
              <button className={`btn ${animate2 ? `slide-in` : ''} relative flex items-center gap-1 bg-neutral-600 px-9 py-4 border-4 border-none text-base bg-inherit rounded-xl font-semibold text-white cursor-pointer overflow-hidden transition-all duration-600 ease-custom hover:text-black hover:rounded-3xl group hover:transition-all duration-700 hover:duration-700`}>
                ...
                <span className="relative z-[1] transition-all duration-700 ease-custom -translate-x-3 group-hover:translate-x-3" onClick={myProjectBtn}>See More</span>
          ...
          <div className="firstContent 2xl:ml-40 text-3xl 2xl:w-1/2">
            ...
            <div className="text-center 2xl:text-left">
              ...
              <a href="mailto:gautamadarrel06@gmail.com?subject=From%20Website%20Email">
                <button className={`cta flex mt-10`}>
                  <span className="hover-underline-animation"> gautamadarrel06@gmail.com </span>
                  <svg
                    id="arrow-horizontal"
                    xmlns="http://www.w3.org/2000/svg"
                    width="30"
